...
#title(xlab="Temperature (\u00B0C)", line=2.5,cex.lab=1.5)
box(lwd=3)
polygon(c(br$temp[br$site=="Auba"],rev(br$temp[br$site=="Auba"])), c(br$l95[br$site=="Auba"],rev(br$u95[br$site=="Auba"])),col=alpha(1,0.4),border=NA)
points(x=br$temp[br$site=="Auba"], y=br$mean[br$site=="Auba"],type="l",col=alpha(1,0.6),lwd=2)
polygon(c(br$temp[br$site=="Bieb"],rev(br$temp[br$site=="Bieb"])), c(br$l95[br$site=="Bieb"],rev(br$u95[br$site=="Bieb"])),col=alpha(2,0.4),border=NA)
points(x=br$temp[br$site=="Bieb"], y=br$mean[br$site=="Bieb"],type="l",col=alpha(2,0.6),lwd=2)
polygon(c(br$temp[br$site=="O3"],rev(br$temp[br$site=="O3"])), c(br$l95[br$site=="O3"],rev(br$u95[br$site=="O3"])),col=alpha(3,0.4),border=NA)
...
plot(1, 1, type= "n",las=1,main="",cex.main=1.5,ylab="", xlab="", ylim=c(min(et$l95),max(et$u95)), xlim=c(min(et$temp),max(et$temp)))
title(ylab="Body length (mm)", line=2.7,cex.lab=1.5)
#title(xlab="Temperature (\u00B0C)", line=2.5,cex.lab=1.5)
box(lwd=3)
polygon(c(et$temp[et$site=="Auba"],rev(et$temp[et$site=="Auba"])), c(et$l95[et$site=="Auba"],rev(et$u95[et$site=="Auba"])),col=alpha(1,0.4),border=NA)
points(x=et$temp[et$site=="Auba"], y=et$mean[et$site=="Auba"],type="l",col=alpha(1,0.6),lwd=2)
polygon(c(et$temp[et$site=="Bieb"],rev(et$temp[et$site=="Bieb"])), c(et$l95[et$site=="Bieb"],rev(et$u95[et$site=="Bieb"])),col=alpha(2,0.4),border=NA)
points(x=et$temp[et$site=="Bieb"], y=et$mean[et$site=="Bieb"],type="l",col=alpha(2,0.6),lwd=2)
polygon(c(et$temp[et$site=="O3"],rev(et$temp[et$site=="O3"])), c(et$l95[et$site=="O3"],rev(et$u95[et$site=="O3"])),col=alpha(3,0.4),border=NA)
...
#title(xlab="Temperature (\u00B0C)", line=2.5,cex.lab=1.5)
box(lwd=3)
polygon(c(ed$temp[ed$site=="Auba"],rev(ed$temp[ed$site=="Auba"])), c(ed$l95[ed$site=="Auba"],rev(ed$u95[ed$site=="Auba"])),col=alpha(1,0.4),border=NA)
points(x=ed$temp[ed$site=="Auba"], y=ed$mean[ed$site=="Auba"],type="l",col=alpha(1,0.6),lwd=2)
polygon(c(ed$temp[ed$site=="Bieb"],rev(ed$temp[ed$site=="Bieb"])), c(ed$l95[ed$site=="Bieb"],rev(ed$u95[ed$site=="Bieb"])),col=alpha(2,0.4),border=NA)
points(x=ed$temp[ed$site=="Bieb"], y=ed$mean[ed$site=="Bieb"],type="l",col=alpha(2,0.6),lwd=2)
polygon(c(ed$temp[ed$site=="O3"],rev(ed$temp[ed$site=="O3"])), c(ed$l95[ed$site=="O3"],rev(ed$u95[ed$site=="O3"])),col=alpha(3,0.4),border=NA)
...
title(xlab="Temperature (\u00B0C)", line=2.5,cex.lab=1.5)
box(lwd=3)
polygon(c(hs$temp[hs$site=="Auba"],rev(hs$temp[hs$site=="Auba"])), c(hs$l95[hs$site=="Auba"],rev(hs$u95[hs$site=="Auba"])),col=alpha(1,0.4),border=NA)
points(x=hs$temp[hs$site=="Auba"], y=hs$mean[hs$site=="Auba"],type="l",col=alpha(1,0.6),lwd=2)
polygon(c(hs$temp[hs$site=="Bieb"],rev(hs$temp[hs$site=="Bieb"])), c(hs$l95[hs$site=="Bieb"],rev(hs$u95[hs$site=="Bieb"])),col=alpha(2,0.4),border=NA)
points(x=hs$temp[hs$site=="Bieb"], y=hs$mean[hs$site=="Bieb"],type="l",col=alpha(2,0.6),lwd=2)
polygon(c(hs$temp[hs$site=="O3"],rev(hs$temp[hs$site=="O3"])), c(hs$l95[hs$site=="O3"],rev(hs$u95[hs$site=="O3"])),col=alpha(3,0.4),border=NA)
...
title(xlab="Temperature (\u00B0C)", line=2.5,cex.lab=1.5)
box(lwd=3)
polygon(c(ov$temp[ov$site=="Auba"],rev(ov$temp[ov$site=="Auba"])), c(ov$l95[ov$site=="Auba"],rev(ov$u95[ov$site=="Auba"])),col=alpha(1,0.4),border=NA)
points(x=ov$temp[ov$site=="Auba"], y=ov$mean[ov$site=="Auba"],type="l",col=alpha(1,0.6),lwd=2)
polygon(c(ov$temp[ov$site=="Bieb"],rev(ov$temp[ov$site=="Bieb"])), c(ov$l95[ov$site=="Bieb"],rev(ov$u95[ov$site=="Bieb"])),col=alpha(2,0.4),border=NA)
points(x=ov$temp[ov$site=="Bieb"], y=ov$mean[ov$site=="Bieb"],type="l",col=alpha(2,0.6),lwd=2)
polygon(c(ov$temp[ov$site=="O3"],rev(ov$temp[ov$site=="O3"])), c(ov$l95[ov$site=="O3"],rev(ov$u95[ov$site=="O3"])),col=alpha(3,0.4),border=NA)
...
title(xlab="Temperature (\u00B0C)", line=2.5,cex.lab=1.5)
box(lwd=3)
polygon(c(po$temp[po$site=="Auba"],rev(po$temp[po$site=="Auba"])), c(po$l95[po$site=="Auba"],rev(po$u95[po$site=="Auba"])),col=alpha(1,0.4),border=NA)
points(x=po$temp[po$site=="Auba"], y=po$mean[po$site=="Auba"],type="l",col=alpha(1,0.6),lwd=2)
polygon(c(po$temp[po$site=="Bieb"],rev(po$temp[po$site=="Bieb"])), c(po$l95[po$site=="Bieb"],rev(po$u95[po$site=="Bieb"])),col=alpha(2,0.4),border=NA)
points(x=po$temp[po$site=="Bieb"], y=po$mean[po$site=="Bieb"],type="l",col=alpha(2,0.6),lwd=2)
polygon(c(po$temp[po$site=="O3"],rev(po$temp[po$site=="O3"])), c(po$l95[po$site=="O3"],rev(po$u95[po$site=="O3"])),col=alpha(3,0.4),border=NA)
