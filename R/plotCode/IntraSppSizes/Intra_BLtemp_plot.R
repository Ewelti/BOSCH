...
points(x=af$temp[af$site=="Auba"], y=af$mean[af$site=="Auba"],type="l",col=alpha(1,0.2), lwd=2)
polygon(c(af$temp[af$site=="Bieb"],rev(af$temp[af$site=="Bieb"])), c(af$l95[af$site=="Bieb"],rev(af$u95[af$site=="Bieb"])),col=alpha(2,0.2),border=NA)
points(x=af$temp[af$site=="Bieb"], y=af$mean[af$site=="Bieb"],type="l",col=alpha(2,0.2), lwd=2)
polygon(c(af$temp[af$site=="O3"],rev(af$temp[af$site=="O3"])), c(af$l95[af$site=="O3"],rev(af$u95[af$site=="O3"])),col=alpha(3,0.2),border=NA)
points(x=af$temp[af$site=="O3"], y=af$mean[af$site=="O3"],type="l",col=alpha(3,0.2), lwd=2)
polygon(c(af$temp[af$site=="W1"],rev(af$temp[af$site=="W1"])), c(af$l95[af$site=="W1"],rev(af$u95[af$site=="W1"])),col=alpha(4,0.2),border=NA)
...
polygon(c(ed$temp[ed$site=="W1"],rev(ed$temp[ed$site=="W1"])), c(ed$l95[ed$site=="W1"],rev(ed$u95[ed$site=="W1"])),col=alpha(4,0.2),border=NA)
points(x=ed$temp[ed$site=="W1"], y=ed$mean[ed$site=="W1"],type="l",col=alpha(4,0.2), lwd=2)
add_silhouette(
...
#title(xlab="Temperature (\u00B0C)", line=2.5,cex.lab=1.5)
box(lwd=3)
polygon(c(gr$temp[gr$site=="Auba"],rev(gr$temp[gr$site=="Auba"])), c(gr$l95[gr$site=="Auba"],rev(gr$u95[gr$site=="Auba"])),col=alpha(1,0.2),border=NA)
points(x=gr$temp[gr$site=="Auba"], y=gr$mean[gr$site=="Auba"],type="l",col=alpha(1,0.2), lwd=2)
polygon(c(gr$temp[gr$site=="Bieb"],rev(gr$temp[gr$site=="Bieb"])), c(gr$l95[gr$site=="Bieb"],rev(gr$u95[gr$site=="Bieb"])),col=alpha(2,0.2),border=NA)
points(x=gr$temp[gr$site=="Bieb"], y=gr$mean[gr$site=="Bieb"],type="l",col=alpha(2,0.2), lwd=2)
polygon(c(gr$temp[gr$site=="O3"],rev(gr$temp[gr$site=="O3"])), c(gr$l95[gr$site=="O3"],rev(gr$u95[gr$site=="O3"])),col=alpha(3,0.2),border=NA)
points(x=gr$temp[gr$site=="O3"], y=gr$mean[gr$site=="O3"],type="l",col=alpha(3,0.2), lwd=2)
polygon(c(gr$temp[gr$site=="W1"],rev(gr$temp[gr$site=="W1"])), c(gr$l95[gr$site=="W1"],rev(gr$u95[gr$site=="W1"])),col=alpha(4,0.2),border=NA)
points(x=gr$temp[gr$site=="W1"], y=gr$mean[gr$site=="W1"],type="l",col=alpha(4,0.2), lwd=2)
add_silhouette(
